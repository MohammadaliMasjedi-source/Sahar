...
- see review progress **persist** in `localStorage` using the same **Leitner box model** as Pantheon
...
(`E:\Mo Pers\Pantheon\docs\ARCHITECTURE-STANDARD.md`). See [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md).
