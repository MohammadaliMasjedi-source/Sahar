# Module skeleton — age band 14–16
...
age 12–14), and has no shipped or drafted content. It is the first step of the "Sahar for Teens"
extension named in `packs/teen-critical-thinking/README.md` ("the safe half of the 'Sahar for
Teens' idea"). Two consequences:
...
2. **Because there is no precedent gate-pass at this age yet**, treat every judgment call more
   conservatively than the younger bands, not less. The closest precedent is
   `packs/teen-critical-thinking/` (aimed at ~13–16, overlapping the bottom of this band) — its
   `RED-TEAM.md` is required reading before drafting anything here.

## UN/UNICEF positioning (metadata only — not curriculum content)

Primary anchor: **SDG Target 4.1** (upper-secondary education) beginning to sit alongside
**SDG Target 4.3** (equal access to technical/vocational/tertiary education, which starts to
become relevant at this age) and **4.4** (relevant skills for employment, emerging). Read together
with **4.7** (global citizenship). Developmentally: UNICEF's adolescence framing, moving from
"early adolescence" (~10–14) into "late adolescence" (~15–19). See
...
2. **Child-safety / safeguarding adviser** — note: at this age "child-safety" in the legal/ethical
   sense still fully applies (a 14–16-year-old is a minor everywhere Sahar is used); do not treat
   this reviewer's role as less strict because the audience is older.
...
> at this age band.** At 14–16, "health & well-being" content can plausibly extend into puberty,
> sexual/reproductive health, mental health, and relationships — the exact "sensitive half" that
...
> That stands unchanged here. **No AI assistant may draft any content in this category, at any
> stage, for any reason — not a rough draft, not an outline, not a list of topics to cover, not
> even in response to a direct instruction to do so.** This category is authored **only** by a
> qualified human subject-matter expert (a health educator or clinician with adolescent-health
> training), from the first word, and requires the full 3-reviewer gate above plus a dedicated
> decision from Mo on scope and approach before a single sentence is proposed as a PR — exactly as
> `packs/teen-critical-thinking/README.md` already states this must work. This skeleton contains
> no such content and never will.
...
- [ ] Pack shape follows the reader-lesson format precedent
      ...
      for a different shape is documented in the PR.
...
- [ ] Child-safety adviser sign-off recorded — at this age, explicitly confirm the content
      couldn't be read as encouraging risky behavior, doesn't pressure disclosure, and remains
      appropriate given local legal/cultural context for a 14–16-year-old.
- [ ] Secular/regional-context reviewer sign-off recorded.
- [ ] All facts/statistics hand-checked.
- [ ] Repo-visibility / governance question explicitly re-confirmed with Mo for this pack (don't
      assume the answer given for an earlier pack still applies).
