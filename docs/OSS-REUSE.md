...
| Option | License | Use |
|---|---|---|
| **SM-2 / Leitner box** (our current engine) | algorithm = public domain; our impl MIT | **Shipping now.** Mirrors `Pantheon/leitner.html` — boxes 1–5, intervals `[1,2,4,9,21]` days. Tiny, transparent, **works fully offline with no library.** |
