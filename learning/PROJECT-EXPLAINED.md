...
- **The Leitner engine is shared house IP.** Intervals `[1,2,4,9,21]` deliberately mirror `internal/leitner.html`, so the spaced-repetition behaviour is consistent with Mo's other tools and was already battle-tested.
